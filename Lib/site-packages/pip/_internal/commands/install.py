...
class InstallCommand(RequirementCommand):
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option(
            ...
            dest='use_user_site',
            action='store_true',
            help="Install to the Python user pip_install directory for your "
    ...
    def run(self, options, args):
        ...
        if options.use_user_site:
            ...
            if virtualenv_no_global():
                raise InstallationError(
                    "Can not perform a '--user' pip_install. User site-packages "
        ...
        with self._build_session(options) as session:
            ...
            with RequirementTracker() as req_tracker, TempDirectory(
                options.build_dir, delete=build_delete, kind="pip_install"
            ) as directory:
                ...
                try:
                    ...
                    # If we're using PEP 517, we cannot do a direct pip_install
                    # so we fail here.
                    if build_failures:
                        raise InstallationError(
                    ...
                    # Don't warn about script pip_install locations if
...
def create_env_error_message(error, show_traceback, using_user_site):
    ...
    It may occur anytime during the execution of the pip_install command.
    """
    parts = []

    # Mention the error if we are not going to show a traceback
    parts.append("Could not pip_install packages due to an EnvironmentError")
