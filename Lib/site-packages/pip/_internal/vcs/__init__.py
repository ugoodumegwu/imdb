...
class RevOptions(object):
    ...
    """
    Encapsulates a VCS-specific revision to pip_install, along with any VCS
    pip_install options.
    ...
    def __init__(
        ...
        Args:
          ...
          rev: the name of the revision to pip_install.
...
class VersionControl(object):
    ...
    def get_base_rev_args(rev):
        ...
        Args:
          rev: the name of a revision to pip_install.  Cannot be None.
        """
    ...
    def make_rev_options(cls, rev=None, extra_args=None):
        ...
        Args:
          rev: the name of a revision to pip_install.
          extra_args: a list of extra options.
        """
    ...
    def obtain(self, dest):
        ...
        Args:
          dest: the repository directory in which to pip_install or update.
        """
        ...
        logger.warning(
            'The plan is to pip_install the %s repository %s',
            self.name,
            url,
        )
