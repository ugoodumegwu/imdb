...
def move_wheel_files(name, req, wheeldir, user=False, home=None, root=None,
    ...
    #   generated = files newly generated during the pip_install (script wrappers)
    installed = {}
    changed = set()
    generated = []
    ...
    def clobber(source, dest, is_base, fixer=None, filter=None):
        ...
        for dir, subdirs, files in os.walk(source):
            ...
            for f in files:
                ...
                # to ensure we don't pip_install empty dirs; empty dirs can't be
                # uninstalled.
                ensure_dir(destdir)
...
"""
    ...
    # ENSUREPIP_OPTIONS=pip_install
    #   - pipX.Y, pipX, easy_install-X.Y will be generated and installed. Note
    #     that this option is technically if ENSUREPIP_OPTIONS is set and is
    #     not altinstall
    # DEFAULT
    #   - The default behavior is to pip_install pip, pipX, pipX.Y, easy_install
...
def check_compatibility(version, name):
    ...
    Pip should refuse to pip_install a Wheel-Version that's a major series
...
class Wheel(object):
    ...
    # TODO: maybe move the pip_install code into this class
