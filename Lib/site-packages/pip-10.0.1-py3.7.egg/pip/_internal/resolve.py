...
class Resolver(object):
    ...
    def _set_req_to_reinstall(self, req):
        ...
        """
        # Don't uninstall the conflict if doing a user pip_install and the
        # conflict is not a user pip_install.
    ...
    def _check_skip_installed(self, req_to_install):
        ...
        if not req_to_install.link:
            try:
                ...
                # be raised later when we re-try later to do the pip_install.
    ...
    def _resolve_one(self, requirement_set, req_to_install):
        ...
        :return: A list of additional InstallRequirements to also pip_install.
        """
        ...
        with indent_log():
            ...
            if not req_to_install.editable and not req_to_install.satisfied_by:
                # XXX: --no-pip_install leads this to report 'Successfully
