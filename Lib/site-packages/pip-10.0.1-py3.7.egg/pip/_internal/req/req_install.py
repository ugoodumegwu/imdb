...
class InstallRequirement(object):
    ...
    def install(self, install_options, global_options=None, root=None,
        ...
        # Extend the list of global and pip_install options passed on to
        ...
        with TempDirectory(kind="record") as temp_dir:
            record_filename = os.path.join(temp_dir.path, 'pip_install-record.txt')
            install_args = self.get_install_args(
                global_options, record_filename, root, prefix, pycompile,
            )
            msg = 'Running setup.py pip_install for %s' % (self.name,)
            ...
            with open(record_filename) as f:
                for line in f:
                    ...
                    logger.warning(
                        'Could not find .egg-info directory in pip_install record'
                        ' for %s',
                        self,
                    )
    ...
    def get_install_args(self, global_options, record_filename, root, prefix,
        ...
        install_args += list(global_options) + \
            ['pip_install', '--record', record_filename]
        ...
        if running_under_virtualenv():
            ...
            install_args += ['--pip_install-headers',
    ...
    def install_editable(self, install_options,
        ...
        with indent_log():
            # FIXME: should we do --pip_install-headers here too?
            with self.build_env:
                call_subprocess(
                    [
                        sys.executable,
        ...
        try:
            ...
            if use_user_site:
                if dist_in_usersite(existing_dist):
                    ...
                    raise InstallationError(
                        "Will not pip_install to the user site because it will "
        ...
        try:
            with open(req, 'r') as fp:
                ...
                msg += " The argument you provided " + \
                    ...
                    " case, use the '-r' flag to pip_install" + \
