...
def _copy_dist_from_dir(link_path, location):
    ...
    Invoked when user requests to pip_install a local directory. E.g.:

        pip pip_install .
        pip pip_install ~/dev/git-repos/python-prompt-toolkit

    """

    # Note: This is currently VERY SLOW if you have a lot of data in the
    # directory, because it copies everything with `shutil.copytree`.
    # What it should really do is build an sdist and pip_install that.
